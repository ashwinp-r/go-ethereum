...
func NewNodeIterator(state *StateDB, blockNr uint32) *NodeIterator {
	return &NodeIterator{
		state: state,
		blockNr: blockNr,
	}
...
func (it *NodeIterator) step() error {
	...
	if it.stateIt == nil {
		it.stateIt = it.state.trie.NodeIterator(nil, it.blockNr)
	}
	...
	it.dataIt = dataTrie.NodeIterator(nil, it.blockNr)
